...
required_files=("cert.pem" "key.pem" "db.root.signed" "CoreFile")
missing_files=()
...
sudo cp "$1/cert.pem" "$1/key.pem" "$1/db.root.signed" "$1/CoreFile" "$1/config.json" /opt/coredns/

# Step 3: Print sha256sum of dsset-.
